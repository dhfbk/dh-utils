    ...
    public static void main(String[] args) {
        ...
        try {
            final CommandLine cmd = CommandLine
                    ...
                    .withOption("t", "token-settings", "token settings", "FILE", CommandLine.Type.FILE_EXISTING, true,
                            false, false)
                    .withLogger(LoggerFactory.getLogger("eu.fbk")).parse(args);

            File corpusFile = cmd.getOptionValue("i", File.class);
            File outputFile = cmd.getOptionValue("o", File.class);
            File settingsFile = cmd.getOptionValue("t", File.class);
            ...
            if (settingsFile != null) {
                props.setProperty("ita_toksent.model", settingsFile.getAbsolutePath());
            }
