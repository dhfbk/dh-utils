...
public class CollectTrainingForNer extends AbstractWikipediaExtractor {

    private static final Logger LOGGER = LoggerFactory.getLogger(CollectTrainingForNer.class);
    ...
    public CollectTrainingForNer(int numThreads, int numPages, Locale locale, String posModel) {
...
//            String posModel = "/Users/alessio/Documents/Resources/ita-models/italian5.tagger";
            ...
            CollectTrainingForNer collectTraining = new CollectTrainingForNer(threads, Integer.MAX_VALUE, Locale.ITALIAN, posModel);
