            ...
            while ((line = reader.readLine()) != null) {
                ...
                for (CoreMap sentence : annotation.get(CoreAnnotations.SentencesAnnotation.class)) {
                    for (CoreLabel token : sentence.get(CoreAnnotations.TokensAnnotation.class)) {
                        ...
                        newToken.append(token.get(CoreAnnotations.LemmaAnnotation.class));
                        newToken.append("_");
                        newToken.append(token.get(CoreAnnotations.PartOfSpeechAnnotation.class));
                        sentenceBuffer.append(newToken.toString().replaceAll("\\s+", "").toLowerCase()).append(" ");
