...
public class FramenetFulltextExtractorJson {
    ...
    public static void main(String[] args) {
        try {
            ...
            for (File file : inFolder.listFiles()) {
                ...
                File outputFile = new File(outFolder + File.separator + name + ".json");
...
//
//                    stringBuffer.append(buffer.toString()).append("\n");
                }

                jo.addProperty("q", stringBuffer.toString());
                jo.addProperty("source", "en");
                jo.addProperty("target", "it");
                jo.addProperty("format", "text");
